...
const navItems = [
  ...
  { to: '/tax', label: 'Tax Estimate', icon: 'tax' },
...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-[#0F111A] flex">
      <aside
        className={`
          fixed inset-y-0 left-0 z-40 w-64 bg-[#13161C]/95 backdrop-blur-xl border-r border-white/5
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between p-4 border-b border-white/5">
            <Link to="/dashboard" className="flex items-center gap-2">
              ...
              <span className="font-semibold text-white">TaxPal</span>
            </Link>
            <button
          ...
          <div className="p-4 border-t border-white/5">
            <div className="flex items-center gap-3 px-3 py-2 mb-2">
              <div className="w-9 h-9 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 font-semibold text-sm">
      ...
      <div className="lg:pl-64 flex-1 flex flex-col min-h-screen">
        <header className="sticky top-0 z-30 flex items-center gap-4 px-4 sm:px-6 py-4 bg-[#0F111A]/80 backdrop-blur-xl border-b border-white/5">
          <button
